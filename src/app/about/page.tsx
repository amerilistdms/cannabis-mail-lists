    ...
    <main className="flex-1">
      ...
      <section className="bg-frost pt-[88px] md:pt-[96px]">
        <div className="mx-auto flex w-full max-w-[1120px] flex-col items-center gap-12 px-5 py-12 md:gap-[75px] md:px-10 md:py-16">
          <div className="flex max-w-[795px] flex-col items-center gap-8 text-center md:gap-[51px]">
            <h1>
            ...
            <p className="text-base leading-6 text-foreground">
              Cannabis Email Lists was created to help cannabis marketers, CBD brands, dispensaries,
              agencies, and related businesses connect with qualified prospects through accurate
              audience data and marketing intelligence.
            </p>
          </div>
          <div className="grid w-full gap-6 md:grid-cols-2 md:gap-8">
            <div className="relative aspect-square overflow-hidden md:h-[522px] md:aspect-auto">
              <Image src="/images/figma/about-1.png" alt="" fill className="object-cover" sizes="523px" />
            </div>
            <div className="relative aspect-square overflow-hidden md:h-[522px] md:aspect-auto">
              <Image src="/images/figma/about-2.png" alt="" fill className="object-cover" sizes="523px" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-12 px-5 py-16 md:gap-[50px] md:px-10 md:py-20">
          <div className="flex flex-col items-center gap-10 md:flex-row md:justify-between">
            ...
            <div className="relative h-[280px] w-full max-w-[523px] overflow-hidden md:h-[370px]">
              <Image src="/images/figma/about-3.png" alt="" fill className="object-cover" sizes="523px" />
            </div>
          </div>

          <div className="flex flex-col items-center gap-10 md:flex-row md:justify-between">
            <div className="relative h-[280px] w-full max-w-[523px] overflow-hidden md:h-[370px]">
              <Image src="/images/figma/about-4.png" alt="" fill className="object-cover" sizes="523px" />
            </div>
            <div className="w-full max-w-[523px] space-y-4 text-xl leading-normal md:text-2xl">
              <p>
                Since 2002, AmeriList has helped businesses, agencies, nonprofits, and organizations
                nationwide improve campaign performance through data driven marketing solutions.
              </p>
              <p>
