...
export function Accuracy() {
  return (
    <section className="relative z-10 -mt-[100svh] bg-white">
      <div
        data-reveal
        className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-10 overflow-hidden md:flex-row md:gap-12"
      >
        <div data-reveal-child className="relative aspect-square w-full max-w-[600px] shrink-0 md:w-[50%]">
          <Image
